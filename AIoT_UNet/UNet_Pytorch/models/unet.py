...
import models.utils_model as um
...
class Unet(nn.Module):
    def __init__(self, filters, drop_r=0.5):
        ...
        self.up1 = um.Up_Block(filters * 16, filters * 8, drop_r)
        self.up2 = um.Up_Block(filters * 8, filters * 4, drop_r,)
        self.up3 = um.Up_Block(filters * 4, filters * 2, drop_r,)
        self.up4 = um.Up_Block(filters * 2, filters, drop_r,)
